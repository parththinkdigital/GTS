export const metadata = {
  title: "Terms of Service - GTS Finlabs",
  description: "Terms of Service Agreement for GTS Finlabs Pvt. Ltd.",
};
...
const TERMS_SECTIONS = [
  ...
  },
  {
    ...
    content:
      "By using this Site, You acknowledge and agree that you will not upload, post, or otherwise transmit or distribute any content that:\n\n• Is illegal or promotes illegal activity.\n• Promotes child exploitation or child pornography.\n• Promotes terrorism or violence.\n• Promotes spam, hacking, cracking, or unauthorized access.\n• Infringes intellectual property rights.\n• Violates privacy or confidentiality obligations.\n• Interferes with the operation of the Site.\n• Contains viruses, malware, trojans, cryptocurrency miners, or other harmful code.\n\nYou further agree not to:\n\n• Copy or distribute any portion of this Site without authorization.\n• Modify or alter any part of this Site or related technologies.\n• Access Company Content through unauthorized technologies or means.",
  },
  {
    number: "4",
    title: "Intellectual Property",
    content:
      "In addition to the general rules above, the provisions in this Section apply specifically to your use of Companies Content posted to Site. Companies Content on this Site, including without limitation the text, software, scripts, source code, API, graphics, photos, sounds, music, videos and interactive features and the trademarks, service marks and logos contained therein (“Companies Content”), are owned by or licensed to GTS Finlabs Pvt. Ltd. in perpetuity, and are subject to copyright, trademark, and/or patent protection. Companies Content is provided to you “as is”, “as available” and “with all faults” for your information and personal, non-commercial use only and may not be downloaded, copied, reproduced, distributed, transmitted, broadcast, displayed, sold, licensed, or otherwise exploited for any purposes whatsoever without the express prior written consent of Company. No right or license under any copyright, trademark, patent, or other proprietary right or license is granted by this Agreement.",
  },
  {
    number: "5",
  ...
  {
    number: "6",
    title: "Company's Use of User Content",
    content:
  ...
  },
  {
    ...
    content:
      "If you have any questions about this Agreement, please contact us by email: info@gtsfinlabs.com",
  },
];
  ...
  return (
    <div className="section" style={{ paddingTop: "clamp(120px, 15vh, 180px)", paddingBottom: "clamp(80px, 10vh, 120px)" }}>
      <div className="container" style={{ maxWidth: "min(90vw, 860px)", margin: "0 auto", padding: "0 32px" }}>
        ...
        {/* Terms Sections — single container, separated by hr lines */}
        ...
        <div style={{ marginTop: "clamp(60px, 8vw, 96px)" }}>
          ...
          >
            ...
            >
              ...
              >
                If you have any questions about this Agreement, please reach out to our team.
              </p>
              <a
